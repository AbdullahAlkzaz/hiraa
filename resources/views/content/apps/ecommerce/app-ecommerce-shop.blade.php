...
<section id="ecommerce-products" class="grid-view">
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="{{url('app/ecommerce/details')}}"> Sony 4K Urtla HD LED TV </a>
        <span class="card-text item-company">By <a href="#" class="company-name">Apple</a></span>
      </h6>
      <p class="card-text item-description">
        Sony 4K Urtla HD LED TV has 4K HDR Support. The TV provides clear visuals and provides distinct sound quality
