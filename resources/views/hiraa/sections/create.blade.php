...
<div class="card mb-3">
    <div class="row g-0">
        <div class="col-md-4">
            <!-- مكان عرض الصورة أو الفيديو -->
            <div id="media-preview" class="d-flex justify-content-center align-items-center" style="height: 100%;">
                <img id="image-preview" class="img-fluid rounded-start"
                    style="display: none; max-width: 100%; height: auto;" alt="Image Preview">
                <video id="video-preview" class="img-fluid rounded-start"
                    style="display: none; max-width: 100%; height: auto;" controls>
