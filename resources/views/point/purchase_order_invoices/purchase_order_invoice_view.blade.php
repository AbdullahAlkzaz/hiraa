                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('purchase_order_invoices.index') }}">{{ __('purchase_order_invoices_purchase_order_invoices') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('purchase_order_invoices_show_title') {{$purchase_order_invoice->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/purchase_order_invoices/{{$purchase_order_invoice->id}}"   enctype="multipart/form-data"  novalidate>
 ...
 <div class="col-12">
  ...
  <!--ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/purchase_order_invoices/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/purchase_order_invoices/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul-->
