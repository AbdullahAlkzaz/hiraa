    ...
    <div class="card-content collapse show">
        <div class="card-body">
            <div class="users-list-filter">
                <form action="{{ route('statistics.customers') }}" method="GET">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            ...
                            <fieldset class="form-group">
                                <input class="form-control" id="date_from" name="date_from" type="date" value="@if (isset($_GET['date_from'])){{ $_GET['date_from'] }}@endif" />
                            </fieldset>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            ...
                            <fieldset class="form-group">
                                <input class="form-control" id="date_to" name="date_to" type="date" value="@if (isset($_GET['date_to'])){{$_GET['date_to']}}@endif" />
                            </fieldset>
                        </div>
                ...
                <form action="{{ route('statistics.customersExport') }}" method="post" class="mt-25">
                    @csrf
                    <div class="row">
