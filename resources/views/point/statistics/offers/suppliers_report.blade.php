...
@section('page-script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var url ;
            if(env == "production"){
                url ="{{config('app.qvm_new_url')}}"+'/order/api/v1/qvm/special_offers/monthly-report/date';
            }else{
                url ="{{config('app.qvm_order_base_url')}}"+'/special_offers/monthly-report/date';
