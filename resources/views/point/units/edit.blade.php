    ...
    <form action="{{route('unit.update')}}" method="post">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <input type="hidden" name="deleted" value="{{$units['deleted']}}">
                <div class="form-group">
                    <label class="input-label" for="exampleFormControlInput1">{{ __('name') }}</label>
                    <input type="text" name="name" placeholder="name" class="form-control" value="{{$units['name']}}">
                </div>
                <br>
                <div class="form-group">
                    <label class="input-label" for="exampleFormControlInput1">{{ __('arabic name') }}</label>
                    <input type="text" name="nameAr" value="{{$units['nameAr']}}" placeholder="arabic name" class="form-control">
                </div>
                <br>
