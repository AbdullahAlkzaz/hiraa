                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('baskets.index') }}">{{ __('baskets_baskets') }}</a>
								     ...
								     <li class="breadcrumb-item active">{{ __('Add new baskets_basket') }} 
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  ...
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/baskets') }}"   enctype="multipart/form-data"  novalidate>
                        {!! csrf_field() !!}
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <div class="position-relative has-icon-left">
                                                                    <input  data-toggle="popover" value="{{  old('subscriber_id')   }}" data-placement="left"  data-content="{{ __('baskets_subscriber_id_data-content') }}" data-trigger="hover"  data-original-title="{{ __('baskets_subscriber_id_data-original-title') }}" 
                                                                     type="number"   class="form-control {{ $errors->has('subscriber_id') ? 'is-invalid' : '' }}" name="subscriber_id" placeholder="{{ __('baskets_subscriber_id') }}" data-validation-required-message="{{ __('This field is required') }}" >
