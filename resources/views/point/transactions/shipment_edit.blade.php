                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12" style="display:flex;">
                                                ...
                                                <div class="mb-1 col-md-6">
                                                    <label for="price" class="form-label">مصاريف بوينت</label>
                                                    <div class="input-group input-group-merge ">
                                                        <input type="number" class="form-control form-control-merge"
                                                            value="{{ old('price', 0) }}" id="shipment-price"
                                                            name="price" placeholder="مصاريف بوينت"
                                                            aria-describedby="price" tabindex="3" required disabled />
                                                    </div>
                                                </div>
                                            </div>
                                            @role('admin')
