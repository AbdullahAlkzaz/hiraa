...
@section('content-header')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">{{ __('تعديل مكتب') }}</h2>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{ route('offices.index') }}">{{ __('الشركات') }}</a>
                        </li>


                        <li class="breadcrumb-item active">{{ __('تعديل مكتب') }}
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form-horizontal" role="form" method="POST" action="{{ route("offices.store") }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="display:flex;">
                                                <div class="mb-1 col-md-6" style="margin-left: 10px;">
                                                    <label for="register-username" class="form-label">اسم المكتب</label>
                                                    <input type="text"
                                                ...
                                                <div class="mb-1 col-md-6" style="margin-left: 10px;">
                                                    ...
                                                    <div class="input-group input-group-merge ">
                                                        <input type="text" class="form-control form-control-merge"
                                                            value="{{ old('phone', $office->phone) }}" id="phone" name="phone"
                                                ...
                                                <div class="mb-1 col-md-6">
                                                    ...
                                                    <div class="input-group input-group-merge ">
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('tax_number', $office->office_details->tax_number) }}" id="tax_number"
                                            ...
                                            <div class="col-md-12" style="display:flex;">
                                                <div class="mb-1 col-md-6" style="margin-left: 10px;">
                                                    ...
                                                    <div>
                                                        <img src="{{ asset('storage/' . $office->id_image_back) }}"
                                                ...
                                                <div class="mb-1 col-md-6">
                                                    ...
                                                    <div>
                                                        <img src="{{ asset('storage/' . $office->id_image_front) }}"
                                                            class="image" alt="صورة البطاقة من الأمام"
                                                            onclick="change(this)">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12" style="display:flex;">
                                                <div class="mb-1 col-md-6" style="margin-left: 10px;">
                                                    ...
                                                    <div class="input-group input-group-merge ">
                                                        <input type="text" class="form-control form-control-merge"
                                                            value="{{ old('address_1', $office->address_1) }}" id="address_1"
                                                ...
                                                <div class="mb-1 col-md-6" margin-left: 10px;>
                                                    ...
                                                    <div class="input-group input-group-merge ">
                                                        <input type="text" class="form-control form-control-merge"
                                                            value="{{ old('address_2', $office->address_2) }}" id="address_2"
                                            ...
                                            <div class="col-md-12" style="display:flex;">
                                                ...
                                                <div class="mb-1 col-md-6">
                                                    ...
                                                    <div class="input-group input-group-merge ">
                                                        <input type="text" class="form-control form-control-merge"
                                                            value="{{ old('city', $office->city) }}" id="city" name="city"
                                            ...
                                            <div class="col-md-12" style="display:flex;">
                                                <div class="mb-1 col-md-6" style="margin-left: 10px;">
                                                    ...
                                                    <div class="input-group input-group-merge ">
                                                        <input type="text" class="form-control form-control-merge"
                                                            value="{{ old('area', $office->area) }}" id="area" name="area"
                                                ...
                                                <div class="mb-1 col-md-6">
                                                    ...
                                                    <div class="input-group input-group-merge ">
                                                        <input type="text" class="form-control form-control-merge"
                                                            value="{{ old('postal_code', $office->postal_code) }}" id="postal_code"
                                            ...
                                            <div class="col-md-12" style="display:flex;">
                                                <div class="mb-1 col-md-6" style="margin-left: 10px;">
                                                    ...
                                                    <div class="input-group input-group-merge ">
                                                        <input type="text" class="form-control form-control-merge"
                                                            value="{{ old('manager_name', $office->office_details->manager_name) }}" id="manager_name"
                                                ...
                                                <div class="mb-1 col-md-6" margin-left: 10px;>
                                                    ...
                                                    <div class="input-group input-group-merge ">
                                                        <input type="text" class="form-control form-control-merge"
                                                            value="{{ old('manager_email', $office->office_details->manager_email) }}" id="manager_email"
                                            ...
                                            <div class="col-md-12" style="display:flex;">
                                                <div class="mb-1 col-md-6" style="margin-left: 10px;">
                                                    ...
                                                    <div class="input-group input-group-merge ">
                                                        <input type="text" class="form-control form-control-merge"
                                                            value="{{ old('manager_phone', $office->office_details->manager_phone) }}" id="manager_phone"
                                                ...
                                                <div class="mb-1 col-md-6" margin-left: 10px;>
                                                    ...
                                                    <div class="input-group input-group-merge ">
                                                        <input type="text" class="form-control form-control-merge"
                                                            value="{{ old('manager_national_number', $office->office_details->manager_national_number) }}" id="manager_national_number"
