                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('order_platforms.index') }}">{{ __('order_platforms_order_platforms') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('order_platforms_show_title') {{$order_platform->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/order_platforms/{{$order_platform->id}}"   enctype="multipart/form-data"  novalidate>
  ...
  <!--ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/order_platforms/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/order_platforms/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul-->
