                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('payment_currencies.index') }}">{{ __('payment_currencies_payment_currencies') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('payment_currencies_show_title') {{$payment_currency->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/payment_currencies/{{$payment_currency->id}}"   enctype="multipart/form-data"  novalidate>
  ...
  <!--ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/payment_currencies/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/payment_currencies/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul-->
