    ...
    <div class="col-12">
        <div class="card-one">
            <div class="card-header">
                <h4 class="mb-0">{{ __('shipments Statistics') }}</h4>
            </div>
                        ...
                        <div class="col-lg-4 col-md-3 col-4">
                            <div class="card earnings-card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <h4 class="card-title mb-1">Aramix shipments count</h4>
                                            <div class="font-large-4">{{ $order_status_statistics->aramix_count }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-3 col-4">
                            <div class="card earnings-card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <h4 class="card-title mb-1">Zajil shipments count</h4>
                                            <div class="font-large-4">{{ $order_status_statistics->zajil_count }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="table-responsive mt-1">
                        <table class="table table-hover-animation mb-0">
                            ...
                            <tbody>
                                ...
                                @if($purchase_order->shipping_method)
                                    <tr>
