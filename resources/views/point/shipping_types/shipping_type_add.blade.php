            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ __('Add new shipping_types_shipping_type') }}
                        </li>
                    </ol>
                </div>
            </div>
...
@section('content')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">{{ __('Shipping Type') }}</h2>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a>
                        </li>
                        <li class="breadcrumb-item"><a
                                href="{{ route('shipping-types.index') }}">{{ __('Shipping Type') }}</a>
                        </li>


                        <li class="breadcrumb-item active">{{ __('Add new Shipping Type') }}
                        </li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" role="form" method="POST"
                                    action="{{ url('/shipping-types') }}" enctype="multipart/form-data" novalidate>
                                    {!! csrf_field() !!}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="position-relative has-icon-left">
                                                            ...
                                                            @endif
                                                            <input data-toggle="popover" value="{{ old('name') }}"
                                                                data-placement="left"
                                                                ...
                                                                name="name"
                                                                placeholder="{{ __('shipping_types_name') }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="position-relative has-icon-left">
                                                            ...
                                                            @endif
                                                            <input data-toggle="popover" value="{{ old('en_name') }}"
                                                                data-placement="left"
                                                                ...
                                                                name="en_name"
                                                                placeholder="{{ __('shipping_types_en_name') }}"
                                                                data-validation-required-message="{{ __('This field is required') }}"
                                                                required>
                                                            <div class="form-control-position">
                                                                <i class="feather icon-file-minus"></i>
