                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('transaction_comments.index') }}">{{ __('transaction_comments_transaction_comments') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('transaction_comments_show_title') {{$transaction_comment->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/transaction_comments/{{$transaction_comment->id}}"   enctype="multipart/form-data"  novalidate>
 ...
 <div class="col-12">
  ...
  <!--ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/transaction_comments/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/transaction_comments/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul-->
