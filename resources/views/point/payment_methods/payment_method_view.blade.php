                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('payment_methods.index') }}">{{ __('payment_methods_payment_methods') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('payment_methods_show_title') {{$payment_method->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/payment_methods/{{$payment_method->id}}"   enctype="multipart/form-data"  novalidate>
  ...
  <!--ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/payment_methods/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/payment_methods/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul-->
