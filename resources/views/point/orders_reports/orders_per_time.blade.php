        ...
        <div class="col-12">
            <div class="card-one">
                <div class="card-header">
                    <h4 class="mb-0">{{ __('Orders Statistics') }}</h4>
                </div>
                            ...
                            <div class="col-lg-6 col-md-3 col-6">
                                <div class="card earnings-card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <h4 class="card-title mb-1">Avergae of orders value</h4>
                                                <div class="font-small-4">per {{ request()->group }}</div>
                                                <h5 class="mb-1">{{ $value_average }}</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <h5 class="mb-1">{{ $count_average }}</h5>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($orders_per_time as $purchase)
                                            <tr>
                                                @if(request()->group == "year" || request()->group == "month" || request()->group == "id")
                                                <td>
