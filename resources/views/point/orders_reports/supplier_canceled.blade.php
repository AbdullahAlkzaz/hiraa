...
@section('title', __('Suppliers Pending Orders Report'))
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-datatable table-responsive mt-1 px-2">
                        <table class="table table-hover-animation mb-0" id="peding_orders">
                            <thead>
                                <tr>
                                    <th>#</th>
                            ...
                            <tbody>
                                @foreach ($statistics as $detail)
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td>{{ $companies[$detail->company_id]["company_en_name"] }}</td>
                                        <td>{{ $detail->pending_count }}</td>
                                        <td>{{ $detail->pending_total }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
