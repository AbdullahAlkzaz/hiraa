  ...
  <script>
    ...
    <section class="invoice-preview-wrapper">
        <div class="row invoice-preview">
                    ...
                    <div class="card-body invoice-padding pb-0">
                        ...
                        <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                            <div>
                                ...
                                <p class="card-text mb-25 d-none">Office 149, 450 South Brand Brooklyn</p>
                                <p class="card-text mb-25 d-none">San Diego County, CA 91905, USA</p>
                                <p class="card-text mb-0 d-none">+1 (123) 456 7891, +44 (876) 543 2198</p>
                            </div>
                            <div class="mt-md-0 mt-2">
                                ...
                                <div class="invoice-date-wrapper d-none">
                    ...
                    <div class="card-body invoice-padding pt-0">
                        <div class="row invoice-spacing">
                            <div class="col-xl-8 p-0">
                                <?php $subscriber = $order->subscriber;
                                ?>
                                <h6 class="mb-2">Customer:</h6>
                                <h6 class="mb-25">{{ $subscriber['subscriber_name'] }}</h6>
                                <p class="card-text mb-25 d-none">Shelby Company Limited</p>
                                <p class="card-text mb-25 d-none">Small Heath, B10 0HF, UK</p>
                                <p class="card-text mb-25">{{ $subscriber['subscriber_mobile'] }}</p>
                                <p class="card-text mb-0">{{ $subscriber['subscriber_email'] }}</p>
                            </div>
                            <div class="col-xl-4 p-0 mt-xl-0 mt-2">
                                <h6 class="mb-2 d-none">Payment Details:</h6>
                                <table class="d-none">
                                    <tbody>
                                        <tr>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @foreach ($order->order_items as $key => $order_item)
                                    ...
                                    $tax += $order_item->price * $order_item->quantity * $order_item->default_sales_tax;
                                    ?>
                                    <tr>
                                        <td class="py-1">
                                            <p class="card-text fw-bold mb-25">Name:
                                                {{ ($order_item->product) && $order_item->product['en_name'] != "" ?  $order_item->product['en_name'] : $order_item->product['name'] ?? "-" }}</p>
                                            <p class="card-text text-nowrap">
                                                Brand:
                                                {{ ($order_item->product) ? $order_item->product['brand_name'] : '-' }}                                            </p>
                                            <p class="card-text text-nowrap">
                                                Number:
                                                {{ ($order_item->product) ? $order_item->product['product_number'] : '-' }}                                            </p>
                                            <p class="card-text text-nowrap">
                                                {{-- {{ $order_item->product ? $order_item->product['brand_en_name'] : '-' }} --}}


                                                Availability:
                                                <span
                                                    class="@if ($order_item->order_items_availability_id > 1) text-danger @endif">({{ $order_item->order_items_availability ? $order_item->order_items_availability->en_name : '-' }})</span>
                                            </p>
                                        </td>
                                        <td class="py-1">
                                        ...
                                        <td class="py-1">
                                            <span class="fw-bold">{{ $companies[$order_item->company_id] }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                        ...
                        <div class="row invoice-sales-total-wrapper">
                            <div class="col-md-6 order-md-1 order-2 mt-md-0 mt-3">
                                <p class="card-text mb-0">
                                    <span class="fw-bold d-none">User:</span> <span
                            ...
                            <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                <div class="invoice-total-wrapper">
                                    ...
                                    <div class="invoice-total-item">
                                        ...
                                        <p class="invoice-total-amount">{{ $order->total_price + $tax}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!-- /Invoice -->
            <!-- Invoice Actions -->
            <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2 d-none">
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="position-relative has-icon-left">
                                                        <input readonly data-toggle="popover"
                                                            value="{{ $order->subscriber_name }}" data-placement="left"
                                                ...
                                                <div class="col-md-8">
                                                    <div class="position-relative has-icon-left">
                                                        <input data-toggle="popover"
                                                            value="{{ $order->company_distance }}" data-placement="left"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="position-relative has-icon-left">
                                                        <input data-toggle="popover"
                                                            value="{{ $order->shipping_price }}" data-placement="left"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="position-relative has-icon-left">
                                                        <input data-toggle="popover" value="{{ $order->total_price }}"
                                                            data-placement="left"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="position-relative has-icon-left">
                                                        <input data-toggle="popover"
                                                            value="{{ $order->order_longitude }}" data-placement="left"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="position-relative has-icon-left">
                                                        <input data-toggle="popover"
                                                            value="{{ $order->order_latitude }}" data-placement="left"
                                    ...
                                    <tbody>
                                        @foreach ($order->order_items as $key => $order_item)
                                            <tr>
                                                ...
                                                <td>{{ $order_item->order_items_availability ? $order_item->order_items_availability->en_name : '-' }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
