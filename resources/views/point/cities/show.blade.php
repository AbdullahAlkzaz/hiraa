...
@section('content')
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="form-group">
                                                    <label class="input-label"
                                                        for="exampleFormControlInput1">{{ __('Country name') }}</label>
                                                    <select readonly disabled name="country_id" class="form-control" >
                                                ...
                                                <div class="form-group">
                                                    <label class="input-label"
                                                        for="exampleFormControlInput1">{{ __('Region name') }}</label>
                                                    <select readonly disabled id="region_id" name="region_id" class="form-control" >
                                                        <option>{{ __("Select region") }}</option>
                                                        @foreach ($regions as $region)
                                                            <option
                                                            
                                                            @if ($region['id'] == $city['regionId'])
                                                            selected
                                                             
                                                        @endif 

                                                            data-country_id="{{$region['countryId']}}" value="{{$region['id']}}">{{$region['name']}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control"
                                                        placeholder="{{ __('new_zone') }}" value="{{ $city['name'] }}"
                                                        required>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" name="coordinates" id="coordinates" class="form-control">@foreach ($city['cityPoints'] as $cityPoint)({{ $cityPoint['latitude'] }},{{ $cityPoint['longitude'] }})@endforeach</textarea>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        function initialize() {
            ...
            const polygonCoords = [
                @foreach ($city['cityPoints'] as $cityPoint)
                    {
