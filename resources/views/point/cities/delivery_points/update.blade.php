...
@section('content')
    <form action="{{ route('cities.update.delivery.point',$point['id']) }}" method="post">
        @csrf
        <div class="row">
            <div class="col-6">
                <input type="text" hidden value="{{$point['city_id']}}" name="city_id">
                <input type="text" hidden name="city_choosen" value="{{$point['city_name']}}">
                <div class="form-group">
                    <label class="input-label" for="point_name">{{ __('point name') }}</label>
                    <input type="text" name="point_name" class="form-control" placeholder="{{ __('point name') }}" value='{{$point['point_name']}}'
                           required>
                </div>

                <div class="form-group">
                    <label class="input-label" for="point_name">{{ __('point arabic name') }}</label>
                    <input type="text" name="point_name_ar" class="form-control" placeholder="{{ __('point arabic name') }}" value='{{$point['point_name_ar']}}'
                           required>
                </div>

                <div class="form-group">
                    <input type="text" name="city_name" class="form-control" placeholder="{{ __('City name') }}"
                           value="{{ $point['city_name'] }}" required hidden>
                </div>
                <div class="form-group">
                    <input type="text" name="city_name_ar" class="form-control" placeholder="{{ __('City arabic name') }}"
                           value="{{ $point['city_name_ar'] }}" required hidden>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="point_working_hours" class="form-control" placeholder="{{ __('point working hours') }}"
                           value='{{$point['point_working_hours']}}'
                           required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="point_manager_name" class="form-control" placeholder="{{ __('point manager name') }}"
                           value='{{$point['point_manager_name']}}'
                           required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="point_manager_phone" class="form-control" placeholder="{{ __('point manager phone') }}"
                           value='{{$point['point_manager_phone']}}'
                           required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="point_location"
                              id="coordinates" class="form-control">{{$point['point_location']}}</textarea>
                </div>
            </div>
