                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('order_items_availabilities.index') }}">{{ __('order_items_availabilities_order_items_availabilities') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('order_items_availabilities_show_title') {{$order_items_availability->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/order_items_availabilities/{{$order_items_availability->id}}"   enctype="multipart/form-data"  novalidate>
  ...
  <!--ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/order_items_availabilities/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/order_items_availabilities/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul-->
