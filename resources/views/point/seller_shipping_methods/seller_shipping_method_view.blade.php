...
@section('content-header')
    ...
    @unless(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('Shipping types'))
  <script>
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('seller_shipping_methods.index') }}">{{ __('seller_shipping_methods_seller_shipping_methods') }}</a>
								     ...
								     <li class="breadcrumb-item active">  @lang('seller_shipping_methods_show_title') {{$seller_shipping_method->id}}
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('content')
  <section class="simple-validation">
                    <div class="row">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="/seller_shipping_methods/{{$seller_shipping_method->id}}"   enctype="multipart/form-data"  novalidate>
 ...
 <div class="col-12">
  ...
  <!--ul class="pager">
                 @if($previous)
											<li class="previous">
												<a href="/seller_shipping_methods/{{$previous}}"><i class="ace-icon fa fa-angle-double-right"></i> @lang('messages.previous')   </a>
											</li>
                @endif
                @if($next)
											<li class="next">
												<a href="/seller_shipping_methods/{{$next}}"> @lang('messages.next')   <i class="ace-icon fa fa-angle-double-left"></i> </a>
											</li>
                @endif
	</ul-->
