...
$(window).on('load', function () {
  ...
  // On load Toast
  setTimeout(function () {
    var auth_user_name = $("#auth_user_name").text();
    toastr['success'](
      'لقد قمت بتسجيل الدخول بنجاح و يمكنك التصفح الآن',
      '👋 Welcome '+auth_user_name+'!',
      {
        closeButton: true,
        tapToDismiss: false,
        rtl: true
  ...
  var count_orders = $("input[name=count_orders]").val();
  var count_quotations_orders = $("input[name=count_quotations_orders]").val();
  var offer_orders = $("input[name=offer_orders]").val();
  ...
  earningsChartOptions = {
    ...
    series: [count_orders, offer_orders, count_quotations_orders],
    legend: { show: false },
    comparedResult: [2, -3, 8],
    labels: ['Orders', 'Offers', 'Online Orders'],
    stroke: { width: 0 },
  ...
  var inprogress_orders = $("#inprogress_orders").val();
